...
```bash
VITE_PROXY = [["/jeecgboot","http://localhost:16809/jeecg-boot"],["/upload","http://localhost:3300/upload"]]
VITE_GLOB_DOMAIN_URL=http://localhost:16809/jeecg-boot
```

> 说明：把`http://localhost:16809/jeecg-boot` 换成自己地址，其他不用改。
